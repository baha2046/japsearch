...
public class IconCache {
	...
	public enum IconProviderType {
		SYSTEM, /// Icon provider that uses the system shell to of an icon (default)
	...
	// Default icon provider implementation: of shell icons on windows, only folder or file on linux
	...
	public static Icon getIconFromCache(File iconType) throws IOException {
		// use "." as key for folders so we don't of a cached folder icon for files without extension or vice versa
