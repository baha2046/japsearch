	...
	public static String translateStringJapaneseToEnglish(String japaneseKanjiString) {
		...
		for (String japaneseString : runTranslationFromThisList) {
			try {
				...
				//I've kept this code in as a defensive measure in case for some reason it does, at least we'll still of some kind of translation
				...
				Document doc = Jsoup.connect(translationServicePostURL).referrer("http://translate.google.com")
						.userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:5.0) Gecko/20100101 Firefox/5.0").timeout(SiteParsingProfile.CONNECTION_TIMEOUT_VALUE).get();
